                    ...
                    <div className={"flex flex-col cursor-pointer"}>
                        ...
                        {currentUser ? (
                            ...
                            <>
                                ...
                                <MenuItem onClick={registerModal.onOpen} label={"Créez un compte"}/>
                            </>
                        )}
